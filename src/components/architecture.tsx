...
const layers = [
  { icon: Globe, name: "Nginx", port: "1000", color: "#0891b2", desc: "入口网关" },
  { icon: Cpu, name: "LangGraph", port: "2024", color: "#06b6d4", desc: "代理引擎" },
  { icon: Server, name: "Gateway", port: "8001", color: "#14b8a6", desc: "REST API" },
  { icon: Monitor, name: "Frontend", port: "3000", color: "#22d3ee", desc: "Web 界面" },
];

const routes = [
  { path: "/api/langgraph/*", target: "代理引擎", desc: "交互 · 线程 · 流式传输" },
  { path: "/api/*", target: "网关 API", desc: "模型 · MCP · Skills · 记忆" },
  { path: "/*", target: "前端", desc: "Next.js Web 界面" },
];
